...
COMPOSE_URL="https://raw.githubusercontent.com/mikekasprzak/pds/activitypds/compose.yaml"

# The pdsadmin script.
PDSADMIN_URL="https://raw.githubusercontent.com/mikekasprzk/pds/activitypds/pdsadmin.sh"
